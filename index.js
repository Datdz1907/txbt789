...
// ===== PATTERN DATA =====
const patternData = `

`.trim();
...
function duDoanTheoPattern(history) {
  ...
  if (history.length < 4) {
    method = "random";
    return { du_doan: Math.random() > 0.5 ? "Tài" : "Xỉu", method };
  }
...
function handleResult(data) {
  ...
  // Dự đoán
  const { du_doan, method } = duDoanTheoPattern(lichSuKetQua);
  ...
  lastResult = {
    ...
    ket_qua,
    du_doan,
    method, // thêm thông tin method ở đây
  };

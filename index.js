...
// ===== PATTERN DATA (nhúng trực tiếp) =====
const patternData = `

`.trim();

// Hàm dự đoán dựa theo patternData
function duDoanTheoPattern(history) {
  if (history.length < 4) return Math.random() > 0.5 ? "Tài" : "Xỉu";
...
function handleResult(data) {
  ...
  const du_doan = duDoanTheoPattern(lichSuKetQua);
